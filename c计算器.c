...
int main()
{
        ...
        do
        {
                ...
                {
                case 1:
                        printf("\033[40;34m请输入两个数做加法 运算:\n\033[0m");
                        scanf("%lf%lf", &a, &b);
                        printf("\033[40;33m%lf + %lf=%lf\n\033[0m", a, b, a + b);
                        break;
                case 2:
                        printf("\033[40;34m请输入两个数做减法 运算:\n\033[0m");
                        scanf("%lf%lf", &a, &b);
                        printf("\033[40;33m%lf – %lf=%lf\n\033[0m", a, b, a - b);
                        break;
                case 3:
                        printf("\033[40;34m请输入两个数做乘法 运算:\n\033[0m");
                        scanf("%lf%lf", &a, &b);
                        printf("\033[40;33m%lf × %lf=%lf\n\033[0m", a, b, a * b);
                        break;
                case 4:
                        printf("\033[40;34m请输入两个数做除法 运算:\n\033[0m");
                        scanf("%lf%lf", &a, &b);
                        printf("\033[40;33m%lf ÷ %lf=%lf\n\033[0m", a, b, a / b);
                        break;
                case 5:
                        printf("\033[40;34m请输入两个数做余数 运算:\n\033[0m");
                        scanf("%lf%lf", &a, &b);
                        printf("\033[40;33m%lf ≡ %lf=%lf\n\033[0m", a, b, fmod(a, b));
                        break;
                case 6:
                        printf("\033[40;34m请输入两个数做平方 运算:\n\033[0m");
                        scanf("%lf%lf", &a, &b);
                        printf("\033[40;33m%lf的%lf平方为%lf\n\033[0m", a, b, pow(a, b));
                        break;
                case 7:
                        printf("\033[40;34m请输入两个数做开方 运算:\n\033[0m");
                        scanf("%lf%lf", &a, &b);
